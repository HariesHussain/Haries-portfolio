...
const ContactSection = () => {
  ...
  // Background image scroll-driven zoom animation:
  // Image starts normal (1.0 scale) when section enters/stays in view, and zooms up to 1.35 as section scrolls UP out of view
  const { scrollYProgress } = useScroll({
    target: sectionRef,
    offset: ["start end", "end start"],
  });

  const imageScale = useTransform(scrollYProgress, [0.3, 1], [1.0, 1.35]);
  ...
  return (
    ...
    >
      {/* Background Hero Image with Scroll Zoom Animation */}
      <motion.div
      ...
      >
        <img
          ...
          loading="lazy"
        />
        <div className="absolute inset-0 bg-gradient-to-r from-[#0A0A0A]/90 via-[#0A0A0A]/60 to-[#0A0A0A]/90" />
      </motion.div>
      ...
      <Container className="relative z-10">
        <motion.div
          ...
          className="w-full flex flex-col justify-between min-h-[567.49px]"
        >
          {/* Main Grid: Form Card on Left (511.99x567.49), Contact Info on Right */}
          <div className="w-full flex flex-col lg:flex-row justify-between items-start gap-12 lg:gap-8">
            ...
            <motion.div
              ...
              className="w-full lg:w-[511.99px] bg-white rounded-[24px] box-border shadow-2xl"
              style={{
                padding: "48px 40px",
                minHeight: "567.49px",
              }}
            ...
            {/* Right Column: Contact Info & Heading Container */}
            <motion.div
              variants={itemVariants}
              className="w-full lg:w-[600px] flex flex-col justify-between min-h-[567.49px] pt-4"
            >
              <div>
                ...
                {/* Contact Details List: 423x132.79 with 36px left padding matching div.framer-1ujkyfj in Screenshot 5 */}
                <div
              ...
              <div className="w-full border-t border-[#333333] pt-8 mt-16 flex items-center justify-between">
                {[
                  { name: "LinkedIn", url: "#" },
                  { name: "X.com", url: "#" },
                  { name: "Facebook", url: "#" },
