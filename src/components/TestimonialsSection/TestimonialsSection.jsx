  ...
  return (
    ...
    >
      <Container>
        ...
        <div className="mb-16 md:mb-20 min-h-[187px]">
          <h2
            style={{
        ...
        {/* Testimonials Body Container: 1200x712 matching div.framer-xomfmy */}
        <div className="flex flex-col lg:flex-row items-start justify-between gap-10 lg:gap-16 min-h-[445px]">
          {/* Left Column Image: 392x445 matching img devtools spec */}
          <div className="w-full lg:w-[392px] h-[350px] sm:h-[400px] lg:h-[445px] flex-shrink-0 rounded-[16px] overflow-hidden">
            <img
