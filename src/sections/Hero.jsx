...
const Hero = () => {
  ...
  // Parallax scroll anchored to the parent scroll container
  ...
  // Log values to verify continuous change during scroll
  useMotionValueEvent(scrollYProgress, "change", (latest) => {
    const yVal = latest * -30;
    console.log(`scrollYProgress = ${latest.toFixed(2)} | heroY = ${yVal.toFixed(0)}%`);
  });

  return (
    <div ref={containerRef} className="relative w-full h-screen z-0">
      <motion.section
        ref={sectionRef}
        className="sticky top-0 w-full h-full overflow-hidden bg-paper"
        style={{ y: heroY }}
      >
