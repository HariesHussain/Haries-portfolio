...
const skills = [
    ...
    { name: "JavaScript", icon: <SiJavascript className="w-5 h-5 sm:w-6 sm:h-6" />, size: "col-span-2 sm:col-span-1 sm:row-span-2 row-span-1" },
    ...
    { name: "Framer Motion", icon: <TbBrandFramerMotion className="w-5 h-5 sm:h-6 sm:h-6" />, size: "col-span-2 sm:col-span-1 md:col-span-2 row-span-1" },
